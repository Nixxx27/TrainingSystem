<body> 
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <h4> <i class="fa fa-cube fa-spin fa-2x"></i> <strong>Training Management System</strong> </h4>
             </div>
...
<p class="red"></p>
<div class="row">
    <div class="col-sm-4 col-md-3 col-lg-2"><?php include $views->page('config/menu.php');?></div>
